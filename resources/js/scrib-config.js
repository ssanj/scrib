		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('is-italic')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(apiKey.value)
						]))
				]));
	} else {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('is-italic mt-1')
				]),
			_List_fromArray(
				[
...
_Platform_export({'Config':{'init':$author$project$Config$main($elm$json$Json$Decode$value)(0)}});}(this));