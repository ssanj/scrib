...
var $author$project$Config$jsMessage = _Platform_incomingPort('jsMessage', $elm$json$Json$Decode$value);
var $author$project$Config$JSNotificationError = function (a) {
	return {$: 'JSNotificationError', a: a};
};
var $author$project$Config$subscriptionFailure = function (m) {
	return $author$project$Config$JSNotificationError('subscriptionFailure: ' + m);
};
var $author$project$Config$ApiKeySavedToLocalStorage = {$: 'ApiKeySavedToLocalStorage'};
var $author$project$Config$subscriptionSuccess = function (_v0) {
	var key = _v0.a.a;
	var result = _v0.b;
	if (key === 'ApiKeySavedToLocalStorage') {
		return $author$project$Config$ApiKeySavedToLocalStorage;
	} else {
		var otherKey = key;
		return $author$project$Config$subscriptionFailure('Unhandled JS notification: ' + otherKey);
	}
};
var $author$project$Config$subscriptions = function (_v0) {
	return $author$project$Config$jsMessage(
		A2($author$project$Subs$encodeJsResponse, $author$project$Config$subscriptionSuccess, $author$project$Config$subscriptionFailure));
};
...
var $author$project$Config$apiKeySavedToLocalStorageResponseKey = $author$project$Ports$ResponseKey('ApiKeySavedToLocalStorage');
...
var $author$project$StorageKeys$apiKeyStorageArea = A2(
	$author$project$StorageKeys$StorageArea,
	$author$project$StorageKeys$Local,
	$author$project$StorageKeys$StorageKey('scrib.api.key'));
var $author$project$ApiKey$encodeApiKey = function (_v0) {
	var value = _v0.value;
...
var $author$project$Config$scribMessage = _Platform_outgoingPort('scribMessage', $elm$core$Basics$identity);
var $author$project$Config$saveApiKeyToLocalStorage = function (apiKey) {
	var storageArea = $author$project$StorageKeys$apiKeyStorageArea;
	var saveApiKeyNoteValue = A3($author$project$Ports$JsStorageValue, storageArea, $author$project$StorageKeys$Save, apiKey);
	var responseKey = $elm$core$Maybe$Just($author$project$Config$apiKeySavedToLocalStorageResponseKey);
	var saveApiKeyCommand = A2($author$project$Ports$WithStorage, saveApiKeyNoteValue, responseKey);
	return $author$project$Config$scribMessage(
		A2($author$project$Ports$encodeJsCommand, saveApiKeyCommand, $author$project$ApiKey$encodeApiKey));
};
var $author$project$Config$saveApiKey = $author$project$Config$saveApiKeyToLocalStorage;
var $author$project$Config$handleSavingApiKey = function (model) {
	var _v0 = model.apiKeyInput;
	if (_v0.$ === 'Just') {
		var apiKey = _v0.a;
		return _Utils_Tuple2(
			model,
			$author$project$Config$saveApiKey(
				$author$project$ApiKey$ApiKey(apiKey)));
	} else {
		return $author$project$ElmCommon$onlyModel(model);
	}
};
var $author$project$Config$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ApikKeySaved':
				return $author$project$Config$handleSavingApiKey(model);
			case 'ApiKeySavedToLocalStorage':
				return $author$project$Config$handleApiKeySavedToLocalStorage(model);
			default:
				var error = msg.a;
				return A2($author$project$Config$handleJsNotificationError, model, error);
		}
	});
...
var $author$project$Config$main = $elm$browser$Browser$element(
	{init: $author$project$Config$init, subscriptions: $author$project$Config$subscriptions, update: $author$project$Config$update, view: $author$project$Config$view});
_Platform_export({'Config':{'init':$author$project$Config$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Config.Msg","aliases":{},"unions":{"Config.Msg":{"args":[],"tags":{"ApiKeyEdited":["String.String"],"ApikKeySaved":[],"ApiKeySavedToLocalStorage":[],"JSNotificationError":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));