...
var $author$project$View$emptyModel = A3($author$project$View$Model, $elm$core$Maybe$Nothing, _List_Nil, $elm$core$Maybe$Nothing);
...
var $author$project$View$createNoteItem = function (model) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
				...
				$author$project$View$NoteSelected(
					{
						noteId: model,
						noteText: '# some note-' + $elm$core$String$fromInt(model)
					}))
			]),
		_List_fromArray(
			[
				...
				$elm$html$Html$text(
				'testing ' + $elm$core$String$fromInt(model))
			]));
};
									...
									[
										...
										_List_fromArray(
											[
												...
												A2(
													$elm$core$List$map,
													$author$project$View$createNoteItem,
													_List_fromArray(
