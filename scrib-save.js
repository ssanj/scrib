...
var $author$project$Save$handleEditingNote = F2(
	function (model, newNoteText) {
		var updatedModel = function () {
			var _v0 = model.note;
			if (_v0.$ === 'NoteWithoutId') {
...
var $author$project$Save$handleGoingToView = function (model) {
	return _Utils_Tuple2(
		model,
...
var $author$project$Save$handleNewNote = function (model) {
	return $author$project$ElmCommon$onlyModel(
		_Utils_update(
			$author$project$Save$defaultModel,
		...
		switch (remoteData.$) {
			...
			case 'Failure':
				return $author$project$ElmCommon$onlyModel(
					_Utils_update(
						model,
						{doing: $author$project$Save$Idle, noteContentStatus: $author$project$Save$NeedsToSave, remoteSaveStatus: remoteData}));
			case 'NotAsked':
				return $author$project$ElmCommon$onlyModel(
					_Utils_update(
						model,
...
var $author$project$Save$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoteSavedMsg':
				return $author$project$Save$handleSavingNote(model);
			case 'NoteEditedMsg':
				var newNoteText = msg.a;
				return A2($author$project$Save$handleEditingNote, model, newNoteText);
			case 'NewNoteMsg':
...
var $author$project$Save$viewMarkdownInstructions = A2(
	...
	_List_fromArray(
		[
			...
			$elm$html$Html$Attributes$class('is-large my-6')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Please enter some text to see a preview here')
				]))
		]));
var $elm$html$Html$hr = _VirtualDom_node('hr');
var $elm$html$Html$Attributes$id = $elm$html$Html$Attributes$stringProperty('id');
var $author$project$Save$markdownViewId = 'markdown-view';
...
var $author$project$Save$viewMarkdownPreview = function (noteText) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_explorations$markdown$Markdown$toHtml, _List_Nil, noteText)
							]))
					]))
			]));
};
...
var $author$project$Save$viewInlineSuccessIfAny = A2($author$project$FP$maybe, $author$project$ElmCommon$emptyDiv, $author$project$ElmCommon$addInlineSuccessFlash);
...
var $author$project$Save$main = $elm$browser$Browser$element(
	{init: $author$project$Save$init, subscriptions: $author$project$Save$subscriptions, update: $author$project$Save$update, view: $author$project$Save$view});
