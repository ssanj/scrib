		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'noteId',
					A3($author$project$FP$maybe, $elm$json$Json$Encode$null, $elm$json$Json$Encode$int, model.noteId))
				]));
	});
		...
		switch (msg.$) {
			case 'NoteSaved':
				var newModel = _Utils_update(
					model,
					{
						noteId: $elm$core$Maybe$Just(10)
					});
				return _Utils_Tuple2(
					newModel,
					$author$project$Save$scribMessage(
						A2($author$project$Save$encode, $author$project$Save$SaveMessage, newModel)));
			case 'NoteEdited':
				var noteText = msg.a;
			...
			case 'NewNote':
				var updatedModel = _Utils_update(
					model,
					{noteId: $elm$core$Maybe$Nothing, noteText: ''});
				return _Utils_Tuple2(
					updatedModel,
					$author$project$Save$scribMessage(
						A2($author$project$Save$encode, $author$project$Save$PreviewMessage, updatedModel)));
...
var $author$project$Save$NewNote = {$: 'NewNote'};
var $author$project$Save$NoteSaved = {$: 'NoteSaved'};
var $author$project$Save$ViewNote = {$: 'ViewNote'};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onClick($author$project$Save$ViewNote)
					]),
				_List_fromArray(
					[
